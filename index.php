...
<body>
  ...
  <main class="main">
      ...
      <div class="home__container container grid">
        <div class="home__data">
          ...
          <p class="home__description">
            We have a vast network of logistics partners and we are qualified
            distributors of world class furniture for home, offices, and
            passenger terminals.
          </p>
      ...
      <div class="about__container grid">
        <div class="about__data">
          ...
          <p class="about__description">
            <u><b>Kabayan Cargo Movers - Luxe Interiors</b></u> is a
            comprehensive logistics and moving company offering installations
            or furniture services, transportation, warehousing, and
            furnishing. Based in Queens, NY, our vision is to provide seamless
            solutions to clients of diversified sizes that provide value
            through best services and competitive prices.
          </p>
        </div>
        ...
        <svg
          ...
          <path
            ...
            d="M146.137 4.22643C177.748 -2.97581 206.274 23.1576 229.992 40.5258C251.017 55.9222 262.978 75.8309 272.499 96.7598C282.192 118.066 300.281 142.538 285.25 161.993C269.962 181.783 230.296 177.103 202.881 186.874C182.644 194.086 167.895 207.639 146.137 211.573C119.351 216.416 86.2133 225.465 65.5354 211.707C44.5361 197.736 61.8497 170.746 54.1954 150.402C47.0089 131.301 13.4763 116.078 22.5437 97.4402C31.6999 78.6197 73.623 86.0355 92.3992 71.8745C117.647 52.8331 111.996 12.005 146.137 4.22643Z" />
          <path
            d="M265.796 16.6642H203.683V128.316H265.796V16.6642Z"
            fill="#EBEBEB" />
          <path
            d="M262.671 19.9052H206.165V124.99H262.671V19.9052Z"
            fill="#FAFAFA" />
          <path
            d="M268.421 129.321L265.796 128.316V14.77H268.421V129.321Z"
            fill="#E0E0E0" />
          <path
            d="M263.898 50.1346H206.165V51.253H263.898V50.1346Z"
            fill="#E0E0E0" />
          <path
            d="M263.898 75.1578H206.165V76.2762H263.898V75.1578Z"
            fill="#E0E0E0" />
          <path
            d="M263.898 100.186H206.165V101.304H263.898V100.186Z"
            fill="#E0E0E0" />
          <path
            d="M232.994 50.6915V127.969H235.848V50.6915H232.994Z"
            fill="#E0E0E0" />
          <path
            d="M218.341 19.9052H217.047V50.6963H218.341V19.9052Z"
            fill="#E0E0E0" />
          <path
            d="M229.498 19.9052H228.205V50.6963H229.498V19.9052Z"
            fill="#E0E0E0" />
          <path
            d="M240.651 19.9052H239.357V50.6963H240.651V19.9052Z"
            fill="#E0E0E0" />
          <path
            d="M251.809 19.9052H250.515V50.6963H251.809V19.9052Z"
            fill="#E0E0E0" />
          <path
            d="M203.683 14.77H201.057V129.006H203.683V14.77Z"
            fill="#E0E0E0" />
          <path
            d="M268.421 13.6184H201.057V16.6642H268.421V13.6184Z"
            fill="#E0E0E0" />
          <path
          ...
          <path
            ...
            fill="#263238" />
          <path
            d="M238.335 66.0443L226.178 75.3768L234.701 86.6082L245.098 80.7022L238.335 66.0443Z" />
          <path
          ...
          <path
            d="M258.334 80.745H252.298V82.3726H258.334V80.745Z"
            fill="#FAFAFA" />
          <path
            d="M258.343 82.387H252.284V80.7356H258.343V82.387ZM252.308 82.387H258.315V80.7641H252.308V82.387Z"
            fill="#263238" />
          <path
          ...
          <path
            ...
            fill="#263238" />
          <path
            d="M197.262 114.392V75.8004H250.91V114.392L222.478 114.63L197.262 114.392Z" />
          <g opacity="0.4">
            <path
              opacity="0.4"
              d="M250.91 75.8004H197.262V114.392H250.91V75.8004Z"
              fill="black" />
          </g>
          <path
            d="M222.478 114.63L197.262 114.392V75.8004H222.393L222.478 114.63Z" />
          <path
            d="M210.855 75.8004H207.511V82.4964H210.855V75.8004Z"
            fill="#263238" />
          <path
          ...
          <path
            ...
            fill="#263238" />
          <path
            d="M197.793 57.5922H182.507V79.0317H197.793V57.5922Z"
            fill="#455A64" />
          <path
            d="M197.793 57.5922H182.507V60.0764H197.793V57.5922Z"
            fill="#263238" />
          <path
            d="M197.793 76.5475H182.507V79.0317H197.793V76.5475Z"
            fill="#263238" />
          <path
            d="M194.778 61.604H185.489V66.4487H194.778V61.604Z"
            fill="#263238" />
          <path
          ...
          <path
            d="M175.987 9.3877H167.141V215.331H175.987V9.3877Z"
            fill="#263238" />
          <path
            d="M167.136 18.0776H79.0504V215.336H167.136V18.0776Z"
            fill="#455A64" />
          <path
            d="M81.5235 9.3877H73.3718V215.331H81.5235V9.3877Z"
            fill="#263238" />
          <path
            d="M175.987 9.3877H73.3718V18.0777H175.987V9.3877Z"
            fill="#263238" />
          <path
    ...
    <section class="services section container" id="services">
      ...
      <h4 class="section__subtitle">We’ve got your logistics and moving needs covered. Whether it's a single room furniture move or a full-scale heavy equipment transport, let’s make your project move seamless.</h4>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="services__data">
              ...
              <img src="assets/img/1.svg" class="svg__color services__img" alt="">
              <p class="services__description">
                Perfect for small business looking to ship cargo via domestic or overseas.
              </p>
              <div>
          ...
          <div class="swiper-slide">
            <div class="services__data">
              ...
              <img src="assets/img/2.svg" class="svg__color services__img" alt="">
              <p class="services__description">
                <!-- Relocation or complete room transformation with a selection of furnishings, decor, and color schemes. -->
                Room relocation or transformation with furnishings, decor, colors.
              </p>
              <div>
                <a href="#" class="button button-link">Learn More</a>
              </div>
          ...
          <div class="swiper-slide">
            <div class="services__data">
              ...
              <img src="assets/img/3.svg" class="svg__color services__img" alt="">
              <p class="services__description">
                Designed for clients needing services to clear items from customs.
              </p>
              <div>
                <a href="#" class="button button-link">Learn More</a>
              </div>
          ...
          <div class="swiper-slide">
            <div class="services__data">
              <h3 class="services__subtitle">Transportation</h3>
              <img src="assets/img/4.svg" class="svg__color services__img" alt="">
              <p class="services__description">
                Navigate your journey with our seamless transportation solutions.
              </p>
              <div>
                <a href="#" class="button button-link">Learn More</a>
              </div>
          ...
          <div class="swiper-slide">
            <div class="services__data">
              <h3 class="services__subtitle">Warehousing</h3>
              <img src="assets/img/5.svg" class="svg__color services__img" alt="">
              <p class="services__description">
                <!-- Elevate your supply chain management with our reliable and secure warehousing services. -->
                Optimize your supply chain with reliable, secure warehousing services.
              </p>
              <div>
                <a href="#" class="button button-link">Learn More</a>
              </div>
    ...
    <!-- <section class="app section container">
        <div class="app__container grid">
          ...
          <svg
            class="svg__img svg__color app__img"
            viewBox="0 0 312 256"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
    ...
    <section class="contact section container" id="contact">
      <div class="contact__container grid">
        <div class="contact__content">
          ...
          <img src="assets/img/KCM.png" class="contact__logo" alt="" />
        ...
        <ul class="contact__content grid">
          <li class="contact__address">
            Telephone:
            <span class="contact__information">929-366-6396</span>
          </li>
          <li class="contact__address">
            Email:
  ...
  <script src="https://cdn.customgpt.ai/js/sge.js" defer="" div_id="customgpt_chat" p_id="42535" p_key="504a45c1759080fe87cd44d027ae35cd"></script>
  <script>
